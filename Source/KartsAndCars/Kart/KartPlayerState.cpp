...
{
	SetNetUpdateFrequency(100.0f); // Set a high update frequency for smooth multiplayer experience
	...
	KartAttributeSet = CreateDefaultSubobject<UKartAttributeSet>(TEXT("KartAttributeSet"));
}
...
UKartAttributeSet* AKartPlayerState::GetAttributeSet() const
{
